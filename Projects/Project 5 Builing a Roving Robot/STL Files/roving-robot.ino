...
const int LIGHT_THRESHOLD_MIN = 50;  //The min light level reading to cause movement
const int LIGHT_THRESHOLD_MAX = 800; //The max light level reading to cause movement
const int SPEED_MIN = 20;            //Minimum motor speed
