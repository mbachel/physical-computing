...
const int LIGHT_THRESHOLD_MIN = 100;  //The min light level reading to cause movement
const int LIGHT_THRESHOLD_MAX = 650; //The max light level reading to cause movement
